    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mt-1">
                ...
                <button onClick={(e) => { e.stopPropagation(); addToWishlist(product._id); }}>
                    <Heart 
                        size={18} 
                ...
                <button>
                    {
                        !cartData[product._id] ? (
                            <p onClick={(e) => { e.stopPropagation(); addToCart(product._id); }}>
                            ...
                            <div className="food-item-counter">
                                <p className="counter-btn" onClick={(e) => { e.stopPropagation(); removeFromCart(product._id); }}>
                                ...
                                <p className="counter-btn" onClick={(e) => { e.stopPropagation(); addToCart(product._id); }}>
